            ...
            <div className={"border rounded shadow p-10 "}>
                <div className={"flex justify-center proba-pro-light mb-5"}>
                    <p className={"w-[35vw] text-lg"}>
                        ...
                        ім'я та
                        по-батькові,
                        зворотну адресу і контактні телефони для оперативного вирішення ваших питань та надання адресної
                        допомоги.
                    </p>
                </div>
                ...
                <div className={"flex justify-between px-5 mb-5"}>
                    <p className={"mr-5  text-2xl"}>Адміністратор безпеки АСУ ЗС України (антивірусна підтримка) </p>
