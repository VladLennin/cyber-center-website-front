...
const ProfilePage = () => {
    ...
    return (
        <div className={"flex justify-center items-center min-h-[77vh] flex-col proba-pro-medium"}>
                                ...
                                isShipsRank
                                    ...
                                    <div className={"flex items-center "}>
                                        <select onChange={(e) => {
                                            setNewUser({
                                                ...newUser,
                                                rank: Object.values(MilitaryRank)[Number(e.target.value)]
                                            })
                                        }}
                                                className={"mb-4 px-2 py-1 rounded text-lg w-[100%]"} defaultValue={-1}>
                                            <option disabled={true} value={-1}>Виберіть військове звання</option>
                ...
                <div className={"grid mb-4 grid-cols-2  "}>
                    ...
                    {flags.surname
                        ...
                        <div className={"flex"}>
                            ...
                            } value={newUser.surname} className={"border px-2 py-1 rounded"} placeholder={"Прізвище"}
                                   type="text"/>
                            <button onClick={() => {
